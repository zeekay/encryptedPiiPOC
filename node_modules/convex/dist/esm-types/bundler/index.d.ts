...
export declare function bundle({ ctx, dir, entryPoints, generateSourceMaps, platform, chunksFolder, externalPackagesAllowList, extraConditions, includeSourcesContent, }: {
    ctx: Context;
    dir: string;
    entryPoints: string[];
